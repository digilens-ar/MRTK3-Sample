...
public class DigiOSVoiceUIInterface : MonoBehaviour
{
    ...
    AndroidJavaObject voiceUI_Listener_hide_menu = null;
    AndroidJavaObject voiceUI_Listener_show_menu = null;

    //Voice Commands
    string command1 = "expand object";
    string command2 = "shrink object";
    string command3 = "hide menu";
    string command4 = "show menu";

    //variable names
    string voiceUI_Listener_Class = "com.digilens.digios_unity_plugin.utils.VoiceUI_Listener";
    string voiceUI_Constant_Type = "Voice_Command_CONFIG_TYPE_FEEDBACK_ONLY";
    string attached_Gameobject;
    ...
    void ConfigureVoiceUI()
    {
        ...
        attached_Gameobject = gameObject.name;
    ...
    void RegisterVoiceCommands()
    {
        ...
        voiceUI_Listener_expand = new AndroidJavaObject(voiceUI_Listener_Class, command1,
            voiceUI_Interface_Constants.GetStatic<int>(voiceUI_Constant_Type), attached_Gameobject, "VoiceUI_Callback1");
        voiceUI_Listener_shrink = new AndroidJavaObject(voiceUI_Listener_Class, command2,
            voiceUI_Interface_Constants.GetStatic<int>(voiceUI_Constant_Type), attached_Gameobject, "VoiceUI_Callback2");
        voiceUI_Listener_show_menu = new AndroidJavaObject(voiceUI_Listener_Class, command3,
            voiceUI_Interface_Constants.GetStatic<int>(voiceUI_Constant_Type), attached_Gameobject, "VoiceUI_Callback3");
        voiceUI_Listener_hide_menu = new AndroidJavaObject(voiceUI_Listener_Class, command4,
            voiceUI_Interface_Constants.GetStatic<int>(voiceUI_Constant_Type), attached_Gameobject, "VoiceUI_Callback4");
        ...
        voiceUI_Model.Call("addVoiceUI_Listener", voiceUI_Listener_show_menu);
        voiceUI_Model.Call("addVoiceUI_Listener", voiceUI_Listener_hide_menu);
    ...
    public bool VoiceUI_Stop()
    {
        if (voiceUI_Interface != null) //If voice UI interface is initalized, disconnect service
        {
            ...
            voiceUI_Listener_show_menu.Dispose();
            voiceUI_Listener_hide_menu.Dispose();
    ...
    /// Callback funtion corresponding to the second voice command
    /// </summary>
    public void VoiceUI_Callback4(string voice_command)
    {
        //TODO: Call functions here
